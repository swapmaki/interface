...
export const getTokenLogoURL = (address: string, chainId: ChainId) => {
  return `https://raw.githubusercontent.com/swapmaki/logo/main/${address}.png`
}
...
function getCurrencyLogoUrls(currency) {
  ...
  //if (currency.chainId in BLOCKCHAIN) {
    urls.push(
      `https://raw.githubusercontent.com/swapmaki/logo/main/${
        currency.address
      }.png`
    )
  //}
...
const MoonriverLogo = 'https://raw.githubusercontent.com/swapmaki/logo/main/0x9f6Bb7Db6CF4C513B7DA54AE949a6f25A6187C07.png'
...
const logo: { readonly [chainId in ChainId]?: string } = {
  ...
  [ChainId.MOONBEAM]: MoonriverLogo,
}
