...
export const LOCKER_ADDRESS: AddressMap = {
  [ChainId.ROPSTEN]: '',
  [ChainId.BSC]: '',
  [ChainId.MOONBEAM]: '0xA9Ead5d7C9D0B59A2900824A125F3913009fD638',
}

export const SOLAR_DISTRIBUTOR_ADDRESS: AddressMap = {
  [ChainId.ROPSTEN]: '',
  [ChainId.BSC]: '',
  [ChainId.MOONBEAM]: '0xf03b75831397D4695a6b9dDdEEA0E578faa30907',
}

export const SOLAR_VAULT_ADDRESS: AddressMap = {
  [ChainId.MOONBEAM]: '0x7e6E03822D0077F3C417D33caeAc900Fc2645679',
}

export const SOLAR_MOVR_PAIR: AddressMap = {
  [ChainId.ROPSTEN]: '',
  [ChainId.BSC]: '',
  [ChainId.MOONBEAM]: '0x7eDA899b3522683636746a2f3a7814e6fFca75e1',
}

export const MOVR_USDC_PAIR: AddressMap = {
  [ChainId.ROPSTEN]: '',
  [ChainId.BSC]: '',
  [ChainId.MOONBEAM]: '0xe537f70a8b62204832B8Ba91940B77d3f79AEb81',
}

export const RIB_MOVR_PAIR: AddressMap = {
  [ChainId.ROPSTEN]: '',
  [ChainId.BSC]: '',
  [ChainId.MOONBEAM]: '0x0acDB54E610dAbC82b8FA454b21AD425ae460DF9',
}
...
export const MULTICALL2_ADDRESS: AddressMap = {
  ...
  [ChainId.MOONBEAM]: '0x0128f4Ed7D1C192bd13A09Dc95e25BA0B97BD751',
...
export const WETH9: AddressMap = {
  ...
  [ChainId.BSC_TESTNET]: '',
  [ChainId.MOONBEAM_TESTNET]: '',
  [ChainId.MOONBEAM]: '0x9f6Bb7Db6CF4C513B7DA54AE949a6f25A6187C07',
  [ChainId.AVALANCHE]: '',
  [ChainId.AVALANCHE_TESTNET]: '',
  [ChainId.HECO]: '',
  [ChainId.HECO_TESTNET]: '',
