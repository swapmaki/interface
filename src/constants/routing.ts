...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...
  [ChainId.MOONBEAM]: [...WRAPPED_NATIVE_ONLY[ChainId.MOONBEAM], MOONBEAM.DAI, MOONBEAM.USDC, MOONBEAM.SOLAR, MOONBEAM.BUSD],
}
...
export const FACTORY_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.MOONBEAM]: '0xFB310cab9372677aC9B34b0db1B84746DE684e38',
}
...
export const ROUTER_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.PALM]: '',
  [ChainId.PALM_TESTNET]: '',
  [ChainId.MOONBEAM]: '0x99097335E1A1d817c2d33b4C96a161E6dC46E730',
}


export const INIT_CODE_HASH: string = '0xfbb47eede115805c256afdc5667bf9865f15b4a343f4b2306deada9ff5ae9815'
