...
export const MOONBEAM: { [key: string]: Token } = {
  USDT: new Token(ChainId.MOONBEAM, '0xeFAeeE334F0Fd1712f9a8cc375f427D9Cdd40d73', 18, 'USDT', 'Tether USD'),
  USDC: new Token(ChainId.MOONBEAM, '0x818ec0A7Fe18Ff94269904fCED6AE3DaE6d6dC0b', 6, 'USDC', 'USD Coin'),
  BNB: new Token(ChainId.MOONBEAM, '0xc9BAA8cfdDe8E328787E29b4B078abf2DaDc2055', 18, 'BNB', 'Binance BNB'),
  BUSD: new Token(ChainId.MOONBEAM, '0xA649325Aa7C5093d12D6F98EB4378deAe68CE23F', 18, 'BUSD', 'Binance BUSD Token'),
}
...
export const SOLAR_ADDRESS = {
  ...
  [ChainId.MOONBEAM]: '0x6bD193Ee6D2104F14F94E2cA6efefae561A4334B',
}

export const SOLAR: ChainTokenMap = {
  [ChainId.MOONBEAM]: new Token(ChainId.MOONBEAM, SOLAR_ADDRESS[ChainId.MOONBEAM], 18, 'SOLAR', 'Solarbeam Token'),
}
...
export const WETH9_EXTENDED: { [chainId: number]: Token } = {
  ...
  [SupportedChainId.MOONBEAM]: new Token(
    ChainId.MOONBEAM,
    '0x9f6Bb7Db6CF4C513B7DA54AE949a6f25A6187C07',
    18,
    'GLMR',
    'Moonbeam'
  ),
